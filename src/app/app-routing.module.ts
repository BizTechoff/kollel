...
const routes: Routes = [
  ...
  { path: 'manager', component: ManagerComponent, canActivate: [AdminGuard], data: { name: 'רכז/ת' } },
  { path: 'branch', component: BranchComponent, canActivate: [AdminGuard], data: { name: 'סניף' } },
  ...
  { path: 'managers', component: ManagersComponent, canActivate: [AdminGuard], data: { name: 'רכזים' } },
  { path: 'branches', component: BranchesComponent, canActivate: [AdminGuard], data: { name: 'סניפים' } },
